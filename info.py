...
BOT_TOKEN = environ.get('BOT_TOKEN', "6711098354:AAGWMaQFimoQtanyA1XJQapi_ktwUL3Ghrc")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002227049224') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmr624062:60Vxu4ZvSwuBIhqA@cluster0.uqrvnns.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Vkbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/TMR_how_to_downlod/2') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TMR_update_channel')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002175455437')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002175455437'))
